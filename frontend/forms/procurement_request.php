        ...
        <div class="container-fluid">
          ...
          <div class="row" style="margin-left: 20px;" id="myTable">
              <div class="col-md-10 col-sm-10 col-xs-12">
                <div class="x_panel">
                <form enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" action="../../backend/procurement_insert.php" method="POST" style="border: double; 2px #CDCDCD; width:110%;" class="form-horizontal dropzone form-label-left" novalidate="" >
                      <div >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="gen_id" type="text" class="form-control has-feedback-left" id="inputSuccess3"  readonly="readonly"  value="<?php $gen_id = "PRC". date("YmdHis"); echo "$gen_id"; ?>">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                          </div>
                        </div>
                      </div>
