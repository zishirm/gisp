            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class= "form design">
                    <form enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" action="generic_insert.php" method="POST" style="border: double; 2px #CDCDCD;" class="form-horizontal dropzone form-label-left" novalidate="" >
                        <div >
                            <img class="center" src="..\..\assets\img\gisp_logo.jpg" alt="logo">
