        ...
        <div class="container-fluid">
          ...
          <div class="row" style="margin-left: 20px;" id="myTable">
              <div class="col-md-10 col-sm-10 col-xs-12">
                <div class="x_panel">
                <form enctype="multipart/form-data" id="demo-form2" data-parsley-validate="" action="../../backend/leave_insert.php" method="POST" style="border: double; 2px #CDCDCD; width:110%;" class="form-horizontal dropzone form-label-left" novalidate="" >
                      <div >
                      ...
                      <div class="form-group">
                        ...
                        <div class="card card-stats col-md-7 col-sm-6 col-xs-12" >
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <div class="col-md-7 col-sm-6 col-xs-12 form-group has-feedback" style = "margin-left:6px;">
                            <input name="lev_requestor" type="text" class="form-control has-feedback-left" id="inputSuccess2"  readonly="readonly" value="<?php echo "Requested: ".$fullname; ?>">
                          ...
                          <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="lev_id" type="text" class="form-control has-feedback-left" id="inputSuccess3"  readonly="readonly"  value="<?php $gen_id = "LEA". date("YmdHis"); echo "$gen_id"; ?>">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                          </div>
                        </div>
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="jobtitle" type="text" class="form-control has-feedback-left" id="inputSuccess2"  placeholder= "Jobtitle">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                          </div>
                          <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback" style = "margin-right:8px; margin-left:1px;">
                          <input name="grade" type="text" class="form-control has-feedback-left" id="inputSuccess3" placeholder= "GRADE" >
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                          </div>
                          <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="employee_number" type="text" class="form-control has-feedback-left" placeholder= "Employee Number" id="inputSuccess2">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback" style = "margin-right:8px; margin-left:1px;">
                        <input name="date_started" type="text" class="form-control has-feedback-left" id="inputSuccess3" placeholder= "DATE STARTED" >
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="leave_days" type="text" class="form-control has-feedback-left" id="inputSuccess3" placeholder="No of Days">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        </div>
                      </div>
                      </div>
                      <h4 style="text-align: center;"><b>Leave Details Section</b></h4>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Address Whilst On Leave: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control" rows="3" required="required" placeholder="121 XXX Rd Byo" name="address" style="margin: 0px 4.375px 0px 0px; height: 46px; width: 606px;"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Contact Person: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control" rows="3"  name="contact_name" style="margin: 0px 4.375px 0px 0px; height: 46px; width: 606px;"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Contact Number:  </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control" rows="3" required="required" name="contact_number" style="margin: 0px 4.375px 0px 0px; height: 46px; width: 606px;"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <textarea class="ckeditor col-md-7 col-sm-6 col-xs-12" id="details" name="explanation" cols="100" rows="10" required></textarea>  
                            </div>
                      </div>
