                      ...
                      <?php 
                           include '../backend/db_connect.php'; 
                            $fetchOne = "SELECT generic_request.*, generic_auth.* FROM `generic_request` JOIN generic_auth ON  generic_request.gen_id=generic_auth.gen_id WHERE implementation_status>1";
