                      ...
                      <?php 
                            $fetchOne = "SELECT lev_app.*, lev_authorisation.* FROM `lev_app` JOIN lev_authorisation ON  lev_app.lev_id=lev_authorisation.lev_id WHERE implementation_status>1";
