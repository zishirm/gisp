                      ...
                      <?php 
                           include '../backend/db_connect.php'; 
                            $fetchOne = "SELECT gen_req.*, gen_authorisation.* FROM `gen_req` JOIN gen_authorisation ON  gen_req.gen_id=gen_authorisation.gen_id";
                            ...
                            if ($myResult->num_rows > 0) {
                             while ($row = mysqli_fetch_assoc($myResult)) {
                                    ...
                                    echo $percen = ($authCount/$row['totalAuth'])*100;
                               ...
                               <td>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="70"
                                        aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $percen; ?>%">
                                        <?php echo $percen; ?>
                                    </div>
                                </div>
                                </td>
                               ...
                               <td>HIGH</td>
                               <td class="">
                                    <a href="views/form_view.php">OPEN</a> 
