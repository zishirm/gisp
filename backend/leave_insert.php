...
$requestor = $_POST['lev_requestor'];
$lev_id = $_POST['lev_id'];
$jobtitle = $_POST['jobtitle'];
$grade = $_POST['grade'];
$employee_number = $_POST['employee_number'];
$date_started = "1000-01-01 00:00:00";
        ...
        foreach($_FILES['fileToUpload']['name'] as $key=>$val){
            ...
            if(in_array($fileType, $allowTypes)){
                ...
                if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"][$key], $targetFilePath)){
                    ...
                    $insert = $conn->query("INSERT INTO lev_uploads (lev_id, file_name, file_format, uploader) VALUES ('$lev_id', '$fileName', '$fileType', '$fullname')");
