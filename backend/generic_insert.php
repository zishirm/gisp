...
/*Image Insertion*/
    ...
    $targetDir =  $_SERVER['DOCUMENT_ROOT']."/production/uploads/";
        ...
        foreach($_FILES['fileToUpload']['name'] as $key=>$val){
            ...
            if(in_array($fileType, $allowTypes)){
                ...
                if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"][$key], $targetFilePath)){
                    ...
                    $insert = $conn->query("INSERT INTO gen_uploads (gen_id, file_name, file_format, uploader) VALUES ('$gen_id', '$fileName', '$fileType', '$fullname')");
...
?>
 <script type="text/javascript">
   window.location.href = "dashboard_developer.php?elementId=genReq";
